...
The installation will take about 45 minutes to complete from scratch. After installation, a new folder named `rstudio-data` will appear in the cloned folder. This will be the default RStudio working directory, and it will only access files within this directory. 
